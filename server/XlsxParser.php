<?php
/*
	XlsxParser php class v0.6.8
	MS Excel 2007 workbooks reader
    http://www.phpclasses.org/browse/file/31514.html
...
// Created by Sergey Schuchkin from http://www.sibvision.ru - professional php developers team 2010-2013
...
//		$this->styles = array();
		...
		if ( $relations = $this->getEntryXML("_rels/.rels" ) ) {
			...
			foreach ($relations->Relationship as $rel) {
				...
				if ($rel["Type"] == XlsxParser::SCHEMA_REL_OFFICEDOCUMENT) {
...
//							echo 'workbook relations<br />';
							...
							foreach ($workbookRelations->Relationship as $workbookRelation) {
								...
								if ($workbookRelation['Type'] == XlsxParser::SCHEMA_REL_WORKSHEET) { // Sheets
...
//										echo '<pre>'.htmlspecialchars( print_r( $sheet, true ) ).'</pre>';
								...
								} else if ($workbookRelation['Type'] == XlsxParser::SCHEMA_REL_SHAREDSTRINGS && $this->entryExists( $path )) { // 0.6.6
