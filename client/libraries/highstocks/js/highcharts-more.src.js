...
seriesTypes.arearange = extendClass(seriesTypes.area, {
	...
	drawDataLabels: function () {
		...
		if (dataLabelOptions.enabled || this._hasPointLabels) {
			...
			// Step 1: set preliminary values for plotY and dataLabel and drawMicroplate the upper labels
			i = length;
			while (i--) {
				point = data[i];
...
(function () {
	...
	function initArea(proceed, chart, options) {
		...
		if (this.chart.polar) {
			...
			// Instead of complicated logic to drawMicroplate an area around the inner area in a stack,
			// just drawMicroplate it behind
