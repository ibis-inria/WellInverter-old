...
(function(){
	// canvg(target, s)
	// empty parameters: replace all 'svg' selection on page with 'canvas' selection
...
(function (Highcharts) { // encapsulate
	...
	extend(CanVGRenderer.prototype, {
		...
		/**
		 * Extend SVGRenderer.destroy to also destroy the selection added by CanVGRenderer.
		 */
		destroy: function () {
			var renderer = this;
		...
		/**
		 * Draws the SVG on the canvas or adds a drawMicroplate invokation to the deferred list.
		 */
		draw: function () {
			var renderer = this;
