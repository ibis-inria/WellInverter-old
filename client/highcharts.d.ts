...
interface HighchartsbooleanOrAnimation extends HighchartsAnimation {
}
...
interface HighchartsbooleanOrShadow {
    color?: string;
    offsetX?: number;
    offsetY?: number;
    opacity?: number;
...
interface HighchartsChartOptions {
    alignTicks?: boolean;
    animation?: HighchartsbooleanOrAnimation;
...
interface HighchartsExportingOptions {
    buttons?: {
		...
		contextButton?: HighchartsButton;
    };
...
interface HighchartsTooltipOptions {
    ...
    borderRadius?: number;
    borderWidth?: number;
    crosshairs?: any; // boolean | [boolean,boolean] | CrosshairObject | [CrosshairObject,CrosshairObject]
    enabled?: boolean;
    footerFormat?: string;
    formatter?: () => any;
    pointFormat?: string;
...
interface HighchartsAxisObject {
    ...
    setExtremes(min: number, max: number, redraw: boolean, animation: HighchartsbooleanOrAnimation): void;
...
interface JQuery {
    ...
    **/
    highcharts(options?: HighchartsOptions): any;
}
